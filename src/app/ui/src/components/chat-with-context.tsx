...
function ChatWithContextInner({ className }: ChatWithContextInnerProps) {
	...
	React.useEffect(() => {
		...
		isSessionsPanelOpen,
		isServersPanelOpen,
		/* isSearchPanelOpen, isGlobalSearchOpen, */ errorMessage,
		createNewSession,
	]);
			...
			<main className='flex-1 flex flex-col relative'>
				...
				<div className='flex-1 flex overflow-hidden'>
					<div className='flex-1 flex flex-col'>
						...
						<InputArea onSend={handleSend} disabled={status !== 'open'} />
					</div>
...
export function ChatWithContext({ wsUrl, autoConnect = true, className }: ChatWithContextProps) {
	return (
