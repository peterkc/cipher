	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>Configure the WebSocket connection for real-time chat</CardDescription>
			</CardHeader>
			<CardContent className='space-y-4'>
				...
				<div className='space-y-2'>
					...
					<div className='p-3 bg-muted rounded-md font-mono text-sm break-all'>{currentUrl}</div>
				</div>
				...
				<div className='space-y-2'>
					...
					<div className='flex space-x-2'>
						<Input
							...
							className='font-mono'
						/>
						<Button onClick={handleUpdateUrl} disabled={!customUrl.trim()} size='sm'>
							Update
						</Button>
					</div>
