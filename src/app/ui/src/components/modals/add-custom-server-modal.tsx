						...
						<div className='grid grid-cols-2 gap-4'>
							<div>
								...
								<Select
									...
									onValueChange={(value: ServerCategory) => updateFormData('category', value)}
								>
									<SelectTrigger>
										<SelectValue />
									</SelectTrigger>
					...
					<div className='space-y-4'>
						...
						<div>
							...
							<Select
								...
								onValueChange={(value: ServerType) => updateConfigData('type', value)}
							>
								<SelectTrigger>
									<SelectValue />
								</SelectTrigger>
						...
						<div className='grid grid-cols-2 gap-4'>
							<div>
								...
								<Select
									...
									onValueChange={(value: ServerPlatform) =>
										updateRequirementsData('platform', value)
									}
								>
									<SelectTrigger>
										<SelectValue />
