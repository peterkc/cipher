			...
			<div ref={ref} className={className} {...props}>
				<div className='space-y-3'>
					<div className='grid grid-cols-12 gap-2 items-center'>
						<div className='col-span-5 text-sm font-medium text-muted-foreground'>Key</div>
						<div className='col-span-6 text-sm font-medium text-muted-foreground'>Value</div>
